...
LinkedList<Post*> Network<ItemType>::bSortByUsername(Comparator compare, int* nodeSwapCounter)
{
    LinkedList<Post*>feedCopy(feed_);
    feedCopy.bubbleSort(compare, nodeSwapCounter);
    return feedCopy;
}
